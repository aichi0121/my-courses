...
- 開課安排可記錄課程名稱、批次名稱、開課日期、一般／直播類型，以及已排定、已開課或尚未排定日期的狀態。
- 尚未排定日期的課程會集中顯示在日曆下方，避免遺漏。
- 日曆資料獨立儲存，不會改動既有的課程連結、匯入內容、查詢或合購紀錄。
...
日曆是獨立的開課安排工具，適合把第一批、第二批、第三批等不同開課日放在同一個月份檢視。
...
- 批次名稱，例如「第一批」或「第二批」。
- 開課日期。
- 狀態：已排定／尚未開課、已開課、尚未排定日期。
- 類型：一般課程或直播課。

同一堂課如有多個批次，請分別新增多筆安排；它們會按日期一起顯示在月曆裡。點擊日曆上的安排即可編輯或刪除。尚未決定日期的安排會列在月曆下方的「尚未排定開課日期」區塊。

日曆資料不會自動從課程連結清單帶入，也不會影響既有課程或合購資料，方便在開課資訊尚未完整時獨立維護。
